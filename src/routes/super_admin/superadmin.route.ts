...
class SuperadminRoute implements Routes {
  ...
  private initializeRoutes() {
    ...
    this.router.post(`${this.path}`,validationMiddleware(CreateSuperadminDto, 'body'), superadminAuthMiddleware, 
      this.SuperadminController.createSuperadmin,);
    this.router.put(`${this.path}/:id`, validationMiddleware(CreateSuperadminDto, 'body', true), superadminAuthMiddleware, this.SuperadminController.updateSuperadmin,);
